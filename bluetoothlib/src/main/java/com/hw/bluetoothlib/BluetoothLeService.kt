...
// connection change and services discovered.
    private val mGattCallback: BluetoothGattCallback = object : BluetoothGattCallback() {
        ...
        override fun onReadRemoteRssi(gatt: BluetoothGatt, rssi: Int, status: Int) {
            Log.i(
                TAG,
                "gatt: $gatt, rssi: $rssi, status: $status"
            )
            super.onReadRemoteRssi(gatt, rssi, status)
            if (status == BluetoothGatt.GATT_SUCCESS) {
                val intent = Intent(ACTION_READ_RSSI)
...
// parameter to false.
    ...
    fun getRssiVal(): Boolean {
        return if (mBluetoothGatt == null) false else mBluetoothGatt!!.readRemoteRssi()
    }
    ...
    companion object {
        ...
        const val ACTION_READ_RSSI = "com.example.bluetooth.le.ACTION_READ_RSSI"
